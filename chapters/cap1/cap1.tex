...
\begin{document}
	...
	Entonces, desarrollando la expresión del vector $\vec{r}_{rotacional}$ y derivada temporal (Desde el marco no inercial \mn{Para este tema es fundamental entender en que lugar se encuentra el observador y desde que ejes se están midiendo los vectores. No necesariamente van a ser los mismos.}):
