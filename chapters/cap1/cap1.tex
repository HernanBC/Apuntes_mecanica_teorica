...
\begin{document}
	...
	\end{itemize}
	Estas dos suposiciones se pueden resumir al aceptar trabajar con el Enunciado Fuerte de la Tercera Ley de Newton (\Figref{fig: Nthirdstrong}). De acuerdo a esto, se procederá a construir las expresiones para sistemas de partículas para los conceptos conocidos en la sección anterior.
