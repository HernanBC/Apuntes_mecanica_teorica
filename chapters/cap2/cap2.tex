...
\begin{document}
    ...
    \begin{definition}[\textbf{Grados de Libertad}]
        ...
        \begin{itemize}
            ...
            \item \textbf{n-Partícullas en 3 dimensiones:} 3n grados de libertad, cada partícula individual tiene sus 3 grados de libertada propios y la suma es el total de grados de libertad del sistema.
        \end{itemize}
